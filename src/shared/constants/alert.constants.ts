...
export const MQTT_TOPICS = {
  TELEMETRY: (siteId: string, officeId: string) => `sites/${siteId}/offices/${officeId}/telemetry`,
  DESIRED: (siteId: string, officeId: string) => `sites/${siteId}/offices/${officeId}/desired`,
  REPORTED: (siteId: string, officeId: string) => `sites/${siteId}/offices/${officeId}/reported`,
